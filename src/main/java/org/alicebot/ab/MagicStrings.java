...
public class MagicStrings {
	...
	static {
		root_path = "c:/ab";
		bot_path = (new StringBuilder()).append(root_path).append("/bots").toString();
		bot_name_path = (new StringBuilder()).append(bot_path).append("/super").toString();
		aimlif_path = (new StringBuilder()).append(bot_path).append("/aimlif").toString();
		aiml_path = (new StringBuilder()).append(bot_path).append("/aiml").toString();
		config_path = (new StringBuilder()).append(bot_path).append("/config").toString();
		log_path = (new StringBuilder()).append(bot_path).append("/log").toString();
		sets_path = (new StringBuilder()).append(bot_path).append("/sets").toString();
		maps_path = (new StringBuilder()).append(bot_path).append("/maps").toString();
	}
}
